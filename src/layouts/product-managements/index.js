                    ...
                    {productList ? (productList.length > 0 ?
                      productList.map((row) => (
                        ...
                        >
                          ...
                          <StyledTableCell component="td" scope="row" className="common-25">
                            <img src={row.product_picture} alt={row.product_actual_name} style={{width: '3rem', height: '3rem'}} />
                          </StyledTableCell>
                          <StyledTableCell component="td" scope="row" className="common-25">
                      ...
                      <StyledTableRow key={0} sx={{"&:last-child td, &:last-child th": { border: 0 },}}>
                        <StyledTableCell component="td" scope="row" className="common-25"></StyledTableCell>
                        <StyledTableCell component="td" scope="row" className="common-25"></StyledTableCell>
                        <StyledTableCell align="left" className="common-25">No Product Found</StyledTableCell>
                        <StyledTableCell component="td" scope="row" className="common-25"></StyledTableCell>
                        <StyledTableCell component="td" scope="row" className="common-25"></StyledTableCell>
                      </StyledTableRow>) :
